...
-- if the nth string of the argument contains an even number of characters and 1 is
--  the nth element of the list returned, if the nth string contains an odd number of characters.  
-- For example, parityList ["one", "two", "three", "four"] = [1, 1, 1, 0]. 
